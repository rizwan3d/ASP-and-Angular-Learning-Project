...
namespace ProductStore.Models
{
    public class ProductRepository : IProductRepository
    {
        ...
        public ProductRepository()
        {
            ...
            Add(new Product { EMP = "Hammer2", Suffix = "Hardware2", Amount = 16.99M, StartDate = DateTime.Now, ResponceType = "B", ResponceDate = DateTime.Now, Comment = "Comment", EditBy = "Bee", ViewResponded = false, CLosed = true });
            Add(new Product { EMP = "Yo-yo2", Suffix = "Toys2", Amount = 3.75M, StartDate = DateTime.Now, ResponceType = "A", ResponceDate = DateTime.Now, Comment = "Comment", EditBy = "Lee", ViewResponded = true, CLosed = false });
            Add(new Product { EMP = "Yo-yo2", Suffix = "Toys2", Amount = 3.75M, StartDate = DateTime.Now, ResponceType = "A", ResponceDate = DateTime.Now, Comment = "Comment", EditBy = "Lee", ViewResponded = true, CLosed = false });
            Add(new Product { EMP = "Yo-yo2", Suffix = "Toys2", Amount = 3.75M, StartDate = DateTime.Now, ResponceType = "A", ResponceDate = DateTime.Now, Comment = "Comment", EditBy = "Lee", ViewResponded = true, CLosed = false });
            Add(new Product { EMP = "Yo-yo2", Suffix = "Toys2", Amount = 3.75M, StartDate = DateTime.Now, ResponceType = "A", ResponceDate = DateTime.Now, Comment = "Comment", EditBy = "Lee", ViewResponded = true, CLosed = false });
            Add(new Product { EMP = "Yo-yo2", Suffix = "Toys2", Amount = 3.75M, StartDate = DateTime.Now, ResponceType = "A", ResponceDate = DateTime.Now, Comment = "Comment", EditBy = "Lee", ViewResponded = true, CLosed = false });
